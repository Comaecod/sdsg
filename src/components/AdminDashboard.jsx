...
const CARDS = [
  { to: '/dashboard/admin', icon: '⚙️', title: 'Admin Panel', desc: 'Manage images, feedback, and campus content', color: 'from-blue-500 to-blue-600', roles: ['super_admin', 'admin'] },
  { to: '/dashboard/users', icon: '👥', title: 'User Management', desc: 'Create, edit, and manage user accounts', color: 'from-cyan-500 to-teal-600', roles: ['super_admin', 'admin'] },
  ...
  { to: '/dashboard/feedback', icon: '💬', title: 'Feedback', desc: 'Review user feedback', color: 'from-pink-500 to-rose-600', roles: ['super_admin', 'admin'] },
  { to: '/dashboard/images', icon: '🖼️', title: 'Image Gallery', desc: 'Manage uploaded images', color: 'from-purple-500 to-violet-600', roles: ['super_admin', 'admin'] },
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    getPageViewCount().then(setViewCount);
  }, []);
    ...
    <div className="animate-slideUp">
      <div className="mb-8">
        ...
        <div className="flex items-center gap-4 mt-2 text-sm text-gray-500 dark:text-gray-400">
          <span>👁 {viewCount !== null ? viewCount.toLocaleString() : '...'} total views</span>
