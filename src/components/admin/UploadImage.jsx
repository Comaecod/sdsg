    ...
    <div className="w-full max-w-2xl mx-auto">
      <div className="glass-card p-6 sm:p-8 animate-slideUp">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400">Upload images for carousel, or gallery</p>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <input type="text" value={title} onChange={e => setTitle(e.target.value)} placeholder="e.g. Campus Overview" className="w-full px-4 py-2.5 rounded-xl bg-black/5 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white placeholder-gray-400 outline-none focus:border-primary/50 text-sm" />
          </div>
          ...
          <div>
            ...
            <input type="text" value={subCategory} onChange={e => setSubCategory(e.target.value)} placeholder="e.g. campus-tour, events" className="w-full px-4 py-2.5 rounded-xl bg-black/5 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white placeholder-gray-400 outline-none focus:border-primary/50 text-sm" />
          </div>
